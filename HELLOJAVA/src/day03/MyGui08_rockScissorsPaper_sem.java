...
public class MyGui08_rockScissorsPaper_sem extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					MyGui08_rockScissorsPaper frame = new MyGui08_rockScissorsPaper();
	 ...
	 * Create the frame.
	 */
	public MyGui08_rockScissorsPaper_sem() {
